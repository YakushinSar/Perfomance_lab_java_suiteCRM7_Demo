...
import homework3.wrappers.Input;
import homework3.wrappers.Select;
import homework3.wrappers.Textarea;
...
public class AddOpportunityPage extends BasePage {
    ...
    public AddOpportunityPage isPageOpened() {
        log.info("Waiting for Add Opportunity page to load");
    ...
    public AddOpportunityPage createOpportunity(OpportunityDTO opportunity) {
        log.info("Creating new opportunity with name: '{}'", opportunity.getName());
    ...
    public OpportunityPage clickSave() {
        log.info("Clicking Save button on Add Opportunity page");
